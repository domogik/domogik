...
def upgrade():
    ...
    op.drop_constraint('core_instance_type_ibfk_1', 'core_instance_type', type_='foreignkey')
    ...
    op.drop_table(u'core_instance_type')
...
def downgrade():
    ...
    op.create_table(u'core_instance_type',
    ...
    sa.ForeignKeyConstraint(['device_technology_id'], [u'core_device_technology.id'], name=u'core_instance_type_ibfk_1'),
    ...
    sa.Column(u'instance_type_id', mysql.VARCHAR(length=80), nullable=False),
    ...
    sa.ForeignKeyConstraint(['instance_type_id'], [u'core_instance_type.id'], name=u'core_device_feature_model_ibfk_1'),
    sa.PrimaryKeyConstraint(u'id'),
    mysql_default_charset=u'latin1',
    mysql_engine=u'InnoDB'
    )
