...
Menu.prototype.flyout = function(container, options) {
	...
	container.addClass('fg-menu-flyout').find('li:has(ul)').each(function(){
		...
		$(this).find('a:eq(0)').addClass('fg-menu-indicator').html('<span>' + $(this).find('a:eq(0)').html() + '</span>').hover(
			function(){
...
Menu.prototype.drilldown = function(container, options) {
	...
	var firstCrumb = $('<li class="'+firstCrumbClass+'"><a href="#">'+firstCrumbIcon+firstCrumbText+'</a></li>');
	...
	topList.find('a').each(function(){
		...
		if ($(this).next().is('ul')) {
			$(this)
				...
				.each(function(){ $(this).html('<span>' + $(this).html() + '</span>'); })
