...
/**
 * @fileoverview Generating Domogik for list blocks.
 * @author q.neutron@gmail.com (Quynh Neutron)
 */
'use strict';

goog.provide('Blockly.Domogik.lists');

goog.require('Blockly.Domogik');


Blockly.Domogik['lists_create_empty'] = function(block) {
  // Create an empty list.
  return ['[]', Blockly.Domogik.ORDER_ATOMIC];
};

Blockly.Domogik['lists_create_with'] = function(block) {
...
Blockly.Domogik['lists_repeat'] = function(block) {
  // Create a list with one element repeated.
  var argument0 = Blockly.Domogik.valueToCode(block, 'ITEM',
      Blockly.Domogik.ORDER_NONE) || 'None';
  var argument1 = Blockly.Domogik.valueToCode(block, 'NUM',
      Blockly.Domogik.ORDER_MULTIPLICATIVE) || '0';
  var code = '[' + argument0 + '] * ' + argument1;
  return [code, Blockly.Domogik.ORDER_MULTIPLICATIVE];
};

Blockly.Domogik['lists_length'] = function(block) {
  // List length.
...
Blockly.Domogik['lists_isEmpty'] = function(block) {
  // Is the list empty?
  var argument0 = Blockly.Domogik.valueToCode(block, 'VALUE',
      Blockly.Domogik.ORDER_NONE) || '[]';
...
Blockly.Domogik['lists_indexOf'] = function(block) {
  ...
  if (block.getFieldValue('END') == 'FIRST') {
    var functionName = Blockly.Domogik.provideFunction_(
        'first_index',
        ['def ' + Blockly.Domogik.FUNCTION_NAME_PLACEHOLDER_ + '(myList, elem):',
...
Blockly.Domogik['lists_getIndex'] = function(block) {
  ...
  var list = Blockly.Domogik.valueToCode(block, 'VALUE',
      Blockly.Domogik.ORDER_MEMBER) || '[]';
...
Blockly.Domogik['lists_setIndex'] = function(block) {
  ...
  var value = Blockly.Domogik.valueToCode(block, 'TO',
      Blockly.Domogik.ORDER_NONE) || 'None';
  ...
  function cacheList() {
    ...
    var listVar = Blockly.Domogik.variableDB_.getDistinctName(
  ...
  if (where == 'FIRST') {
    ...
    Blockly.Domogik.definitions_['import_random'] = 'import random';
    var code = cacheList();
    var xVar = Blockly.Domogik.variableDB_.getDistinctName(
...
Blockly.Domogik['lists_getSublist'] = function(block) {
  // Get sublist.
  var list = Blockly.Domogik.valueToCode(block, 'LIST',
      Blockly.Domogik.ORDER_MEMBER) || '[]';
