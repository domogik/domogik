...
# $LastChangedDate: 2008-07-20 20:23:29 +0200 (dim. 20 juil. 2008) $
...
class Root(dbus.service.Object):
    ...
    @dbus.service.method(dbus_interface='org.freedesktop.MediaPlayer',in_signature='', out_signature='(ii)')
...
#        dbus.service.Object.__init__(self, dbus.SessionBus(), '/TrackList')
    ...
    @dbus.service.method(dbus_interface='org.freedesktop.MediaPlayer',in_signature='i', out_signature='a{ss}')
...
#        dbus.service.Object.__init__(self, dbus.SessionBus(), '/Player')
    ...
    def GetStatus(self):
        ...
        return (state[status['state']], int(status['random']), 0, int(status['repeat']))
    
    @dbus.service.method(dbus_interface='org.freedesktop.MediaPlayer',in_signature='', out_signature='a{ss}')
