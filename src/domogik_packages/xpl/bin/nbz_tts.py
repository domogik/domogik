    ...
    def __init__(self):
        ...
        for alias in self.alias_list:
            if str(self.alias_list[alias]['server']) != "None":
                ...
                self.log.error("Can't find the server address for the nabaztag " + str(self.alias_list[alias]['nabaztag']) + " , please check the configuration page of this plugin, use wizz.cc")
                self.force_leave()
                return
