...
device_technology = _db.add_device_technology(dt_id='x10', dt_name=u"x10", dt_description="x10 techno")
...
device_technology = _db.add_device_technology(dt_id='plcbus', dt_name=u"PLCBus", dt_description="plcbus techno")
device_type = _db.add_device_type(dty_name=u"Switch", dt_id=device_technology.id)
_db.add_actuator_feature(af_name=u"Switch", af_value="binary", dty_id=device_type.id, af_unit=None,
                        af_configurable_states="off, on",
...
_db.add_device_technology(dt_id='eibknx', dt_name=u"EIB/KNX", dt_description="EIB/KNX techno")
# Create device technologie features for 1wire
_db.add_device_technology(dt_id='1wire', dt_name=u"1-Wire", dt_description="1-wire techno")
# Create device technologie features for RFXCOM
_db.add_device_technology(dt_id='rfxcom', dt_name=u"RFXCom", dt_description="RFXCom techno")
# Create device technologie features for IR
_db.add_device_technology(dt_id='ir', dt_name=u"IR", dt_description="IR techno")

# Create device technologie features for Computer
device_technology = _db.add_device_technology(dt_id='computer', dt_name=u"Computer", dt_description="Computer or Server hardware")
...
_db.add_device_usage(du_name=u"Air conditioning", du_description="Air conditioning usage")
_db.add_device_usage(du_name=u"Ventilation", du_description="Ventilation usage")
_db.add_device_usage(du_name=u"Heating", du_description="Heating")
...
_db.add_device_usage(du_name=u"Phone", du_description="Phone usage")
_db.add_device_usage(du_name=u"TV", du_description="Television usage")
