...
class ScenarioManager:
    ...
    def __instanciate(self):
        ...
        """
        for _uuid in self._mapping:
            inst = self._mapping[_uuid]
            if type(inst) in [str, unicode]:
                ...
                self._mapping[_uuid] = self._test_cache[inst](self.log, trigger=self.generic_trigger)
